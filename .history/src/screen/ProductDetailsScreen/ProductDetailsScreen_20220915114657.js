...
import CartAlert from "../../components/Alerts/CartAlert/CartAlert.js"
import SelectButton from "../../components/Buttons/SelectButton/SelectButton"
import { fetchSetProductCart } from "../../features/cart/cartSlice.js"
import { fetchProductDetail } from "../../features/product/productSlice"
import { setWithExpiry } from "../../utils/localStorage"
import { Actions, Button, Container, Description, Features, Image, Options, Selections, Selector } from "./productDetailsScreenStyled"
...
const ProductDetailsScreen = () => {
	...
	const [alertCart, setAlertCart] = useState(null)
	...
	const handleSubmit = (e) => {
		...
		if(color[0]?.name != null && storage[0]?.name != null){
			...
			dispatch(fetchSetProductCart(newItemCart))
		} else if (color[0]?.name != null || storage[0]?.name != null){
			setAlertCart(
				<CartAlert
					text='Se te olvida elegir una opción más.'
			...
			setAlertCart(
				<CartAlert
					text='Necesita elegir dos opciones.'
					handleCloseAlert={handleCloseAlert}
				/>
			)
		}
