					...
					<Description>
						<Features>
							<ul>
								...
								<li data-test='OS'><stron>Sistema operativo: </stron>{productDetails.os}</li>
								<li data-test='display-resolution'><strong></strong>Resolución de pantalla: {productDetails.displayResolution}</li>
