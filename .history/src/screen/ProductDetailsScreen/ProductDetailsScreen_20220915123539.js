...
import { fetchSetItemCart } from "../../features/cart/cartSlice.js"
...
import { Actions, 
	...
	Selections, 
	Selector 
} from "./productDetailsScreenStyled"
...
const ProductDetailsScreen = () => {
	...
	const handleSubmit = (e) => {
		...
		if(color[0]?.name != null && storage[0]?.name != null){
			...
			console.log(fetchSetItemCart(newItemCart).getState());
			dispatch(fetchSetItemCart(newItemCart))
